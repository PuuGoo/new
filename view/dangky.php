...
<div class="container-fluid bg-secondary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 100px">
        <h1 class="font-weight-semi-bold text-uppercase mb-3 text-h1">Đăng Ký</h1>
    ...
    <div class="forms">
        <div class="form-content">
            ...
            <form action="index.php?act=dangky" method="post">
                ...
                <div class="field input-field">
                    <input type="text" placeholder="Thành phố giao hàng" name="shipping_city" required>
                </div>
                <div class="field input-field">
                    <input type="text" placeholder="Địa chỉ thanh toán" name="billing_address" required>
                </div>
                <div class="field input-field">
                    <input type="text" placeholder="Thành phố thanh toán" name="billing_city" required>
                </div>
