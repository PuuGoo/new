...
<div class="container-fluid bg-secondary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 100px">
        <h1 class="font-weight-semi-bold text-uppercase mb-3 text-h1">Lịch Sử Đặt Hàng</h1>

    </div>
</div>

<table class="container-lsdh" border="2">
        <thead>
            <tr>
                <th class="thead-item">ID</th>
                <th class="thead-item">Số tiền</th>
                <th class="thead-item">Mã đơn hàng</th>
                <th class="thead-item">Mã sản phẩm</th>
                <th class="thead-item">Ngày tạo</th>
                <th class="thead-item">Ngày cập nhật</th>
            </tr>
        </thead>
        <tbody>
       <?php foreach($lsdh as $ls): ?>
       <tr>
                <td class="tbody-items"><?= $ls['id']?></td>
                <td class="tbody-items"><?= $ls['amount']?></td>
                <td class="tbody-items"><?= $ls['order_id']?></td>
                <td class="tbody-items"><?= $ls['product_id']?></td>
                <td class="tbody-items"><?= $ls['creation_date']?></td>
                <td class="tbody-items"><?= $ls['updation_date']?></td>
            </tr>
